    ...
    <script type="text/javascript">
        $(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $("#activitytBody").on("click","input[name='activity']",function () {
                            // console.log(this);
                            // console.log($(this).attr("activityName"));
                            var activityName = $(this).attr("activityName");
                            $("#create-activitySrc").attr("value",activityName);
                            var activityId = $(this).val();
                            $("#create-activityId").attr("value",activityId);
            ...
            $("#searchContactsText").keyup(function () {
                //收集参数
                var contactsName = $.trim(this.value);
                //发送请求
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (index, obj) {
                            htmlStr += "<tr>";
                            htmlStr += "<td><input type=\"radio\" value=\"" + obj.id + "\" contactsName=\"" + obj.name + "\" name=\"contacts\"/></td>";
                            htmlStr += "<td>" + obj.name + "</td>";
                            htmlStr += "<td>" + obj.startDate + "</td>";
                            htmlStr += "<td>" + obj.endDate + "</td>";
                            htmlStr += "<td>" + obj.owner + "</td>";
                        ...
                        $("#contactstBody").on("click","input[name='contacts']",function () {
                            ...
                            $("#create-activitySrc").attr("value",contactsName);
                            var contactsId = $(this).val();
                            $("#create-contactsId").attr("value",contactsId);
                            $("#findMarketActivity").modal("hide");
                        })
...
<form class="form-horizontal" role="form" style="position: relative; top: -30px;">
    ...
    <div class="form-group">
        ...
        <label for="create-activitySrc" class="col-sm-2 control-label">市场活动源&nbsp;&nbsp;<a href="#"
                                                                                           data-toggle="modal"
    ...
    <div class="form-group">
        <label for="create-contactsName" class="col-sm-2 control-label">联系人名称&nbsp;&nbsp;<a href=""
                                                                                            data-toggle="modal"
                                                                                            data-target="#findContacts"><span
                class="glyphicon glyphicon-search"></span></a></label>
        <div class="col-sm-10" style="width: 300px;">
            <input type="hidden" id="create-contactsId" value="d4a282b1029e44e5940024769b045c0a">
            <input type="text" class="form-control" id="create-contactsName" value="测试">
        </div>
    </div>
