    ...
    <script type="text/javascript">
        ...
        $(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.code == "0") {
                            ...
                            $("#remarkDivList").children(".page-header").after(htmlStr);
                            $("html, body").animate({
                                scrollTop: $("#remarkDivList").offset().top
            ...
            $("#convertBtn").click(function () {
                //发送同步请求
                window.location.href = "workbench/clue/convertClue.do?clueId=${clue.id}";
            });
        });
    ...
    <c:forEach items="${clueRemarkList}" var="clueRemark">
        <c:if test="${clueRemark.editFlag != '1'}">
            <div id="div_${clueRemark.id}" class="remarkDiv" style="height: 60px;">
                <img title="${clueRemark.createBy}" alt="${clueRemark.createBy}" src="image/user-thumbnail.png" style="width: 30px; height:30px;">
                <div style="position: relative; top: -40px; left: 40px;">
                    <h5>${clueRemark.noteContent}</h5>
                    <font color="gray">线索</font> <font color="gray">-</font> <b>${clue.fullName}-${clue.company}</b>
                    <small style="color: gray;">
                            ${clueRemark.editFlag.equals("0")?clueRemark.createTime:clueRemark.editTime}
                        由${clueRemark.editFlag.equals("0")?clueRemark.createBy:clueRemark.editBy}${clueRemark.editFlag.equals("0")?'创建':'修改'}</small>
                    <div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
                        <a class="myHref" name="editA" remarkId="${clueRemark.id}" href="javascript:void(0);"><span
                                class="glyphicon glyphicon-edit"
                                style="font-size: 20px; color: #E6E6E6;"></span></a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a class="myHref" name="deleteA" remarkId="${clueRemark.id}" href="javascript:void(0);"><span
