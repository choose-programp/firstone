...
<div id="remarkDivList" style="position: relative; top: 30px; left: 40px;">
    <div class="page-header" id="remarkInfo">
        <h4>备注</h4>
    </div>

    <!--遍历remarkList，显示所有的备注信息-->
    <c:forEach items="${remarkList}" var="remark">
        <c:if test="${!remark.editFlag.equals(\"1\")}">
            <div id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
                <img title="${remark.createBy}" src="image/user-thumbnail.png" style="width: 30px; height:30px;">
                <div style="position: relative; top: -40px; left: 40px;">
                    <h5>${remark.noteContent}</h5>
                    <font color="gray">市场活动</font> <font color="gray">-</font> <b>${activity.name}</b> <small
                        style="color: gray;"> ${remark.editFlag.equals("0")?remark.createTime:remark.editTime}
                    由${remark.editFlag.equals("0")?remark.createBy:remark.editBy}${remark.editFlag.equals("0")?'创建':'修改'}</small>
